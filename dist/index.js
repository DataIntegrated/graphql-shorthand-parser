  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
      ...
      return [head].concat(babelHelpers.toConsumableArray(tail));
        ...
        peg$c29 = function peg$c29(name, fields) {
      return fields;
    },
        peg$c30 = function peg$c30(name, args, type) {
      return babelHelpers.defineProperty({}, name, babelHelpers.extends({}, type, args && { args: args }));
    },
      ...
      return value;
        ...
        peg$c36 = function peg$c36(char) {
      return char;
    },
        peg$c37 = function peg$c37(comment) {
      return comment.join("").trim();
        ...
        peg$c42 = function peg$c42(comment) {
    ...
    function peg$parseField() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$currPos;
        s3 = peg$parseBEGIN_ARGS();
        if (s3 !== peg$FAILED) {
          s4 = peg$parseFieldList();
          if (s4 !== peg$FAILED) {
            s5 = peg$parseCLOSE_ARGS();
            if (s5 !== peg$FAILED) {
              peg$savedPos = s2;
              s3 = peg$c29(s1, s4);
              s2 = s3;
    ...
    var ENUM = _require.ENUM;
    var INTERFACE = _require.INTERFACE;
